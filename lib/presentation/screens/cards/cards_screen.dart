...
class _CardsView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    //!SingleChildScrollView evita que se desborde,
    //!claro (si no es un widget de lista como lo es lisview tiende a desbordarse)
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          //!que no quede pegado el card al final de la pantalla
          const SizedBox(
            height: 50,
          )
        ],
